$(document).ready(function(){
    ...
    //瀑布流问号
	$(".pubuliuheader i").mouseenter(function(){
		$(".xiangjie").css("display","block")
	})
	$(".xiangjie").mouseleave(function(){
		$(".xiangjie").css("display","none")
	})
	//瀑布流
    ...
    //养花知识
    $(".yhzs").mouseenter(function(){
        $(".yhzs-right-tupian").css("display","block");
    })
    $(".yhzs").mouseleave(function(){
        $(".yhzs-right-tupian").css("display","none");
    })
    $(window).scroll(function(){
