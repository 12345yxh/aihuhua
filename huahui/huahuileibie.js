$(document).ready(function(){
    ...
    $(".huahuidaquan2").click(function(){

    })
    //问号内容
    $(".huadezhonglei i").mouseenter(function(){
        $(".wenhaoxiangqing").css("display","block");
    })
    $(".wenhaoxiangqing").mouseleave(function(){
        $(".wenhaoxiangqing").css("display","none");
    })
    // 回到顶部
